...
├── server/                      # Backend (Node.js + Express + TypeScript + Prisma) — Phase 1 & 2 complete; Phase 3 in progress (Steps 1, 2 & 3 done)
...
│   └── Phase03/               # Phase 3 specs: Plan.md, Requirements.md, Validation.md — Columns & Tasks (Steps 1, 2 & 3 done: schema evolution + access-control loaders + columns module; tasks module pending)
...
- `specs/Phase03/` — Phase 3 detailed deliverables (Plan, Requirements, Validation) — Columns & Tasks (Steps 1, 2 & 3 done: schema evolution + access-control loaders + columns module; tasks module pending)
