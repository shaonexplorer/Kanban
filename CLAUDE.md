...
├── server/                      # Backend (Node.js + Express + TypeScript + Prisma) — Phase 1, 2 & 3 complete; Phase 4 in progress (Steps 1–6 done: schema migration to position String + lexoPosition helper + smoke script + move endpoints for both tasks and columns + frontend board view with drag-and-drop + phase4-e2e.ps1 + Validation.md updated; Step 7 pending: manual browser-based DnD validation)
...
│   └── Phase04/               # Phase 4 specs: Plan.md, Requirements.md, Validation.md — Ordering & Task Movement (Steps 1–6 done: position Int → String migration on Column + Task + lexoPosition helper + smoke script + move endpoints for both tasks and columns + Next.js board view with @dnd-kit + TanStack Query + phase4-e2e.ps1 + Validation.md updated; Step 7 pending: manual browser-based DnD validation)
...
- `specs/Phase04/` — Phase 4 detailed deliverables (Plan, Requirements, Validation) — Ordering & Task Movement (Steps 1–6 done: `position Int → String` migration on `Column` and `Task`; `lexoPosition` helper; move endpoints for tasks and columns; Next.js board view with `@dnd-kit` + TanStack Query; `server/phase4-e2e.ps1` (58 assertions); `Validation.md` updated to document the e2e-script choice; Step 7 pending: manual browser-based DnD validation)
