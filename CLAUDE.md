...
├── server/                      # Backend (Node.js + Express + TypeScript + Prisma) — Phase 1, 2 & 3 complete; Phase 4 in progress (Steps 1–4 done: schema migration to position String + lexoPosition helper + smoke script + move endpoints for both tasks and columns; Steps 5–7 pending)
...
│   └── Phase04/               # Phase 4 specs: Plan.md, Requirements.md, Validation.md — Ordering & Task Movement (Steps 1–4 done: position Int → String migration on Column + Task + lexoPosition helper + smoke script + move endpoints for both tasks and columns; Steps 5–7 pending: dnd-kit frontend)
